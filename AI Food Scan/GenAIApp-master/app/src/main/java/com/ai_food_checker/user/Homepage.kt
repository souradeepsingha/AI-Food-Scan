...
//    lateinit var mAdView : AdView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shortcon.setOnClickListener {
            val intent = Intent(this, MainActivity3::class.java) // Change MainActivity to your desired activity
...
//            val appLink = "This is AI content generator App download the App. This is Link"+" "
//
//            // Create the Intent
//
//            // Create the Intent
